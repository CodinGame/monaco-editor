...
declare namespace monaco.languages.typescript {
    ...
    export class LanguageServiceDefaultsImpl implements LanguageServiceDefaults {
        ...
        constructor(compilerOptions: CompilerOptions, diagnosticsOptions: DiagnosticsOptions, workerOptions: WorkerOptions, inlayHintsOptions: InlayHintsOptions);
    ...
    export const setupMode: (defaults: LanguageServiceDefaults, modeId: string) => Promise<(...uris: Uri[]) => Promise<TypeScriptWorker>>;
}
